      ...
      <div
        ...
        <div class="flex flex-col sm:flex-row items-center gap-3 w-full lg:w-auto">
          ...
          <button @click="goToCreatePage"
            class="w-full sm:w-auto px-6 py-3 bg-[#F7F4F0] hover:bg-amber-950 hover:text-white text-amber-900 border border-[#E2D9CD] text-xs font-black rounded-xl transition-all duration-300 uppercase tracking-widest text-center cursor-pointer shadow-sm flex-shrink-0">
            + Create New Category
          </button>
        </div>
      </div>
            ...
            <tr v-for="category in filteredCategories" :key="category.id"
              ...
              <td class="py-5 px-6 align-top">
                <div class="flex items-start space-x-3.5">
                  <div
                    ...
                    <img :src="getImageUrl(category.image || category.image_path)" alt="Cover"
              ...
              <td class="py-5 px-6 text-right align-top pt-4.5">
                <div class="flex items-center justify-end gap-2">
                  <button @click="goToEditPage(category.id)"
        ...
        <div v-for="category in filteredCategories" :key="category.id" class="p-5 flex flex-col gap-4 bg-white">
          ...
          <div class="flex items-start gap-3.5">
            <div
              ...
              <img :src="getImageUrl(category.image || category.image_path)" alt="Cover" class="w-full h-full object-cover rounded-lg" />
            </div>
            <div class="flex flex-col min-w-0">
...
import apiClient, { projectCategoriesApi, getImageUrl } from '@/api/api'
...
const handleDelete = async (id) => {
  const confirmDelete = confirm(
    'Are you sure you want to permanently delete this project category?'
  )
