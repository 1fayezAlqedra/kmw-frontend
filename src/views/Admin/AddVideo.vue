    ...
    <div class="bg-white rounded-3xl border border-[#EAE3DA] shadow-[0_4px_20px_-4px_rgba(139,92,26,0.05)] w-full overflow-hidden">
      ...
      <form @submit.prevent="handleSubmit" class="p-6 md:p-10 space-y-6 md:space-y-8">
        ...
        <div class="flex flex-col sm:flex-row items-center justify-end gap-3 pt-4 border-t border-[#EAE3DA]/60">
          ...
          <!-- زر الرفع والحفظ بالدرجة البرتقالية الطوبية المحددة بالظبط مع الهوفر الغامق المتناسق -->
          <button
            type="submit"
...
const handleSubmit = async () => {
  ...
  try {
    ...
    // بعد الحفظ بنجاح يتم توجيه المسؤول مباشرة لصفحة الـ Show (الفهرس الأساسي)
